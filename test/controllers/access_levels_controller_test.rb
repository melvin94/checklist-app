...
class AccessLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access_level" do
    assert_difference('AccessLevel.count') do
      post access_levels_url, params: { access_level: { level: @access_level.level, title: @access_level.title } }
    end
  ...
  test "should update access_level" do
    patch access_level_url(@access_level), params: { access_level: { level: @access_level.level, title: @access_level.title } }
