...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { description: @checklist.description, title: @checklist.title } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { description: @checklist.description, title: @checklist.title } }
